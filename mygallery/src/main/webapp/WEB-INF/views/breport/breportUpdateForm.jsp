...
<h2 align="center" style="font-weight:normal; margin:50px 0; margin-bottom:-10px">${ breport.b_no }번 게시글 수정 페이지</h2>
<br>
<!-- 원글 수정 폼 -->
...
<table align="center" width="500" cellspacing="0" cellpadding="5"  class="table"  style="position: relative; left: 150px;">
	...
	<tr><th>내 용</th><td><input type="textarea" name="b_content" value="${ breport.b_content }"></textarea></td></tr>
	<tr><th colspan="2" >
		<input type="submit" value="수정하기" class="button" style="margin: 5px 0;"> &nbsp; 
...
cellpadding="5" class="table">
	...
	<tr><th>내 용</th><td><input type="textarea" name="b_content" value="${ breport.b_content }"></td></tr>
	<tr><th colspan="2">
		<input type="submit" value="수정하기" class="button" style="margin: 5px 0;""> &nbsp; 
		<input type="reset" value="수정취소" class="button"> &nbsp; 
