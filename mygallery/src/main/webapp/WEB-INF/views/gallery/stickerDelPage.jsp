	...
	<table align="center" border="1" cellspacing="0" cellpadding="3" width="700">
		...
		<tr align="center">
			<c:if test="${ g.s_rename != null }">
				<td width="100"><img src="resources/gallery/faceImages/${ g.s_rename }" width="100" height="100"></td>
			<td>${ g.userid }</td>
			<td><fmt:formatDate value="${ g.s_date }" pattern="yyyy-MM-dd"/></td>
			<c:url var="gdel" value="/gdel.do">
					<c:param name="rfile" value = "${ g.s_rename }"/>
					<c:param name="inum" value="${ g.snum }"/>
