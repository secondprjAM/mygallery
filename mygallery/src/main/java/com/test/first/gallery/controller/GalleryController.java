package com.test.first.gallery.controller;
...
//====================================================================================================================================	
	...
	public String imageInsertMethod(Gallery gallery, Model model, 
...
//====================================================================================================================================		
	...
	public String stickerInsertMethod(Gallery gallery, Model model, 
			HttpServletRequest request, 
			@RequestParam(name="upfile", required=false) MultipartFile mfile) {
			logger.info("imginsert.do : " + mfile);
	...
	// ====================================================================================
		...
		public String galleryDeleteMethod(
				@RequestParam("inum") int inum, 
			...
			if(galleryService.deleteGallery(inum) > 0) {
				...
				if(renameFileName != null) {
					new File(	request.getSession().getServletContext().getRealPath(
								"resources/gallery/faceImages") + "\\" + renameFileName).delete();
				}
